...
local points = {
    ...
    {1, 9, 0.648, 0.303, "Dire Maul - East", "dungeon", "55-58", 4},
    {1, 9, 0.624, 0.249, "Dire Maul - North", "dungeon", "57-60", 5},
    {1, 9, 0.604, 0.311, "Dire Maul - West", "dungeon", "57-60", 6},
    {1, 5, 0.29, 0.629, "Maraudon", "dungeon", "46-55", 8},
    {1, 12, 0.53, 0.486, "Ragefire Chasm", "dungeon", "13-18", 10},
    {1, 17, 0.488, 0.919, "Razorfen Downs", "dungeon", "37-46", 11},
    {1, 17, 0.407, 0.873, "Razorfen Kraul", "dungeon", "29-38", 12},
    {1, 17, 0.462, 0.357, "Wailing Caverns", "dungeon", "17-24", 15},
    {1, 15, 0.389, 0.184, "Zul'Farrak", "dungeon", "44-54", 16},
	-- Kalimdor Raids
	{1, 7, 0.53, 0.76, "Onyxia's Lair", "raid", "60", 9},
	{1, 13, 0.296, 0.960, "Ruins of Ahn'Qiraj", "raid", "60", 13},
	{1, 13, 0.282, 0.956, "Temple of Ahn'Qiraj", "raid", "60", 14},
	...
	{1, 7, 0.718, 0.566, "Boat to Menethil Harbor", "boat", "Alliance", nil}, -- alliance
	{1, 9, 0.311, 0.395, "Boat to Forgotten Coast", "boat", "Alliance", nil}, -- alliance
	{1, 9, 0.431, 0.428, "Boat to Sardor Isle", "boat", "Alliance", nil}, -- alliance
	{1, 16, 0.552, 0.949, "Boat to Auberdine", "boat", "Alliance", nil}, -- alliance
    -- Eastern Kingdoms Dungeons
    {2, 15, 0.371, 0.857, "Blackrock Depths", "dungeon", "52-60", 1},
	{2, 5, 0.328, 0.362, "Blackrock Depths", "dungeon", "52-60", 1},
    {2, 24, 0.423, 0.726, "The Deadmines", "dungeon", "17-24", 3},
    {2, 7, 0.178, 0.392, "Gnomeregan", "dungeon", "29-38", 5},
    {2, 7, 0.216, 0.30, "Gnomeregan - Workshop Entrance", "dungeon", "29-38", 5},
    {2, 5, 0.321, 0.386, "Lower Blackrock Spire", "dungeon", "55-60", 8},
	{2, 15, 0.364, 0.879, "Lower Blackrock Spire", "dungeon", "55-60", 8},
    {2, 21, 0.869, 0.323, "Scarlet Monastery - Armory", "dungeon", "32-42", 12}, 
    {2, 21, 0.862, 0.295, "Scarlet Monastery - Cathedral", "dungeon", "35-45", 13}, 
    {2, 21, 0.839, 0.283, "Scarlet Monastery - Graveyard", "dungeon", "26-36", 14},
    {2, 21, 0.850, 0.338, "Scarlet Monastery - Library", "dungeon", "29-39", 15},  -- atlasID for Armory, Cath, GY and Lib are 13, 14, 15
    {2, 23, 0.69, 0.74, "Scholomance", "dungeon", "58-60", 16},
    {2, 16, 0.44, 0.67, "Shadowfang Keep", "dungeon", "22-30", 17},
    {2, 17, 0.399, 0.544, "The Stockade", "dungeon", "24-31", 18},
    {2, 9, 0.31, 0.14, "Stratholme", "dungeon", "58-60", 20},
    {2, 9, 0.47, 0.24, "Stratholme - Back Gate", "dungeon", "58-60", 20},
    {2, 19, 0.701, 0.55, "The Sunken Temple", "dungeon", "50-60", 21},
    {2, 3, 0.429, 0.130, "Uldaman - Main Entrance", "dungeon", "41-51", 23},
    {2, 3, 0.657, 0.438, "Uldaman - Back Entrance", "dungeon", "41-51", 23},
    {2, 5, 0.312, 0.365, "Upper Blackrock Spire", "dungeon", "55-60", 24},
	{2, 15, 0.355, 0.855, "Upper Blackrock Spire", "dungeon", "55-60", 24},
	-- Eastern Kingdoms Raids
	{2, 15, 0.332, 0.851, "Blackwing Lair", "raid", "60", 2},
	{2, 5, 0.273, 0.363, "Blackwing Lair", "raid", "60", 2},
	{2, 15, 0.336, 0.879, "Molten Core", "raid", "60", 10},
	{2, 5, 0.273, 0.387, "Molten Core", "raid", "60", 10},
	{2, 9, 0.40, 0.28, "Naxxramas", "raid", "60", 11},
	{2, 18, 0.53, 0.172, "Zul'Gurub", "raid", "60", 25},
	...
	{2, 17, 0.627, 0.097, "Tram to Ironforge", "tram", "Alliance", nil},  -- alliance
	{2, 12, 0.762, 0.511, "Tram to Stormwind", "tram", "Alliance", nil},  -- alliance
